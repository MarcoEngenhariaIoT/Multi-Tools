...
echo.   Versão Marco Notebooks 1.2 15/08/2026

choice /c "ABCDEFGHIJZ" /n /m " Digite a opção desejada > "

:: O choice retorna números: A=1, B=2, C=3... Z=26
:: Então usamos if para cada opção
if errorlevel 26 goto Z
if errorlevel 25 goto J
if errorlevel 24 goto I
if errorlevel 23 goto H
if errorlevel 22 goto G
if errorlevel 21 goto F
if errorlevel 20 goto E
if errorlevel 19 goto D
if errorlevel 18 goto C
if errorlevel 17 goto B
if errorlevel 16 goto A
goto M
